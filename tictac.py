...
class Start:
    ...
    def __init__(self):
        ...
        self.l1 = Label(self.frame, text="Tic-Tac-Toe", font=self.font)
    ...
    def update(self):
        ...
        if winning:
            ...
            if self.buttons[winning[0]]['text'] == 'O':
                ...
                language = 'en'
                mytext = "Your not a noob your a pro"
                myobj = gTTS(text=mytext, lang=language, slow=False)
                myobj.save("test.mp3")
                playsound.playsound('test.mp3')
                os.remove('test.mp3')
...
class GUI:
    ...
    def update(self):
        ...
        if winning and self.buttons[winning[0]]['text'] == 'O':
            language = 'en'
            mytext = "You are dog shit at this game"
            myobj = gTTS(text=mytext, lang=language, slow=False)
            myobj.save("test.mp3")
            playsound.playsound('test.mp3')
            os.remove('test.mp3')
            ...
            if winning:
                language = 'en'
                mytext = "you are the best at tic tac toe, master"
                myobj = gTTS(text=mytext, lang=language, slow=False)
                myobj.save("test.mp3")
                playsound.playsound('test.mp3')
                os.remove('test.mp3')
